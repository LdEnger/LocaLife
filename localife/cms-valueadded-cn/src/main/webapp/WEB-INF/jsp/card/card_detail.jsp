...
<div data-options="region:'center',title:'活动卡券管理'" class="regionCenter">
		<div id="card_toolbar">
			...
			<div>
				<label>选择战区：</label> 
				<select id="zone" onchange="javascript:initBranch(this.value);" >
			...
			<input type="button" id="batch_del" class="btn btn-success" value="批量删除">
			</div>
		</div>
    	...
    	<td>活动名称:</td><td>
    		<select id="s_editActivity" style="width:200px;">
  	   	...
  	   	<tr>
    	<td>生成卡用户：</td><td><input type="text" id="s_editUser"  style="width:200px;border:0;" value="${currentUser.zoneName}/${currentUser.branchName}/${currentUser.hallName}/${currentUser.userName}" readonly></td>
    	</tr>
   		<tr>
    ...
    <div id="batch_card_dialog" data-options="closed:true,modal:true,title:'批量生成激活码',iconCls:'icon-save'" style="padding:5px;width:500px;height:300px;">
       ...
       <div id="import_card_dialog" data-options="closed:true,modal:true,title:'导入',iconCls:'icon-save'" style="padding:5px;width:500px;height:300px;">
    	...
    	<td>活动名称:</td><td>
  	  	...
  	  	<tr>
    	<td>导入文件:</td><td><span id="ImportFileName" ></span><input type="button" id="import_card" class="btn btn-success" value="选择文件"></td>
    	</tr>
  			    <tr>
			   		<td>下载Excel模板:</td>
			   		<td>
			   			<input type="button"  class="btn btn-success" value="下载" onclick="javascript:window.location.href='<%=basePath%>excelDemo/batchUploadVipDemo.xlsx'"/>
			   		</td>
			    </tr>
    	</table>
    </div>	
