...
<body class="easyui-layout">
	<div data-options="region:'center',title:'用户管理'" class="regionCenter">
		<div id="common_search" class="common_search">
			...
			<label>分公司名称：</label> <select id="q_branch"
			...
			</select> <label>营业厅名称：</label> <select id="q_hall">
				<option value="-1">全部</option>
            ...
            <br>
            <span class="required">*</span>温馨提示：仅需要通过用户名查询出本地生活管理员用户结果，不需要其它查询条件。
        </div>
