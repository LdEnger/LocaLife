...
public class ActivityOrder extends Entity implements Serializable {
	 ...
	 * @param handleTime
	 */
	public ActivityOrder(int chargingId, int price, String chargingName, int duration, String chargingPic, String activityOrderId, int activityType
			, int uid, String uname, String mac, String sn, String devicecode, int activityStatus, String handleTime) {
		this.activityOrderType = activityType;
		switch (activityType) {
		case 0:
			this.activityOrderTypeName = "免费vip";
