...
<script type="text/javascript" src="js/activity/activity.js?v=2"></script>
<style>
.tableC3 th {
	font-weight: normal;
	text-align: right;
	...
	<div data-options="region:'center',title:'活动管理'" class="regionCenter">
		...
		<div id="activity_toolbar">
			<input type="button" id="add_activity" class="btn btn-success"
				value="新增"> <label>活动卡状态：</label> <select id="status">
		...
		<div id="activity_detail_dialog"
			...
			<table class=tableC3>
				...
				<tr>
					<th>有效期：</th>
					<td><input type="text" id="editEffectiveTime"><label> 天</label></td>
				</tr>
				<tr>
					<th>&nbsp;</th>
					<td><span class="fcR">卡激活时间+活动有效期内可以使这张卡</span></td>
				</tr>
				<tr>
					<th>状态：</th>
