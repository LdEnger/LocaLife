...
<div id="common_search" class="common_search">
	...
	<input type="hidden" id="role_add" class="btn btn-success" value="添加角色">
	</div>
	<table id="role_table"></table>
	<div id="role_detail_dialog" data-options="closed:true,modal:true,title:'角色信息',iconCls:'icon-save'" style="padding:5px;width:500px;height:450px;">
