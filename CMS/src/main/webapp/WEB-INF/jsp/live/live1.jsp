...
<script type="text/javascript" src="js/live/live.js?v=${js_version}"></script>
...
<div data-options="region:'center',title:'直播管理'" class="regionCenter">
	<div id="live_toolbar" >
		...
		<input type="hidden"  id="hiddenPath"/>
			...
			<div style="height: 40px;padding-top: 5px;" style="display: none">
				<label>公司名称：</label> 
		...
		<c:if test="${currentUser.roleId==2}">
			<input type="button" id="query_live" name="export_live" class="btn btn-success" value="导出" onclick="initDownLoad()">
			<font color="red">单次最多导出5万条，若结果集大于5万条，取就近时间的</font>
		</c:if>
		</div>
	</div>
	...
	<div id="single_live_dialog" data-options="closed:true,modal:true,title:'单个开通直播服务',iconCls:'icon-save'" style="padding:5px;width:400px;height:350px;">
		<table>
			<tr>
				<td>分公司名称：</td>
				<td><select id = "single_branchName" name="single_branchName" type="text"></select></td>
			</tr>
			<tr>
				<td>营业厅名称：</td>
				<td><select id = "single_hallName" name="single_hallName" type="text"></select></td>
			</tr>
			<tr>
				<td>产品包名称：</td>
				<td>
	...
	<div id="renew_live_dialog" data-options="closed:true,modal:true,title:'续费直播服务',iconCls:'icon-save'" style="padding:5px;width:400px;height:500px;">
		<table>
			...
			<input type="hidden" id="renew_hallId">
			<tr>
	    		<td>订单号:</td>
		    	<td><input type="text" id="renew_liveOrderId"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>
    		</tr>
    		<tr>
    			<td>用户ID:</td>
				<td><input type="text" id="renew_uid"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		   
		    </tr>
		    <tr>
		    	<td>MAC地址:</td>
				<td><input type="text" id="renew_mac"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		  
		    </tr>
		    <tr>
		    	<td>SN号:</td>
				<td><input type="text" id="renew_sn"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		   
		   	</tr>
		   	<tr>
		   		<td>所属分公司:</td>
				<td><input type="text" id="renew_branchName" style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>
		    </tr>
			<tr>
				<td>营业厅名称：</td>
				<td><input type="text" id="renew_hallName" style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"/></td>
			</tr>
		    <tr>
		    	<td>产品包名称:</td>
				<td><input type="text" id="renew_productName"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		  
			</tr>
			<tr>
		    	<td>生效时间:</td>
				<td><input type="text" id="renew_openTime"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		  
			</tr>
			<tr>
		    	<td>失效时间:</td>
				<td><input type="text" id="renew_closeTime"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		    
			</tr>
<!-- 			<tr> -->
<!-- 		    	<td>结束日期：</td> -->
<!-- 		    	<td> -->
...
<!-- 		    </tr> -->
	...
	<div id="refund_live_dialog" data-options="closed:true,modal:true,title:'续费直播服务',iconCls:'icon-save'" style="padding:5px;width:400px;height:450px;">
		<table>
			...
			<tr>
	    		<td>订单号:</td>
		    	<td><input type="text" id="refund_liveOrderId"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>
    		</tr>
    		<tr>
    			<td>用户ID:</td>
				<td><input type="text" id="refund_uid"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		   
		    </tr>
		    <tr>
		    	<td>MAC地址:</td>
				<td><input type="text" id="refund_mac"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		  
		    </tr>
		    <tr>
		    	<td>SN号:</td>
				<td><input type="text" id="refund_sn"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		   
		   	</tr>
		   	<tr>
		   		<td>所属分公司:</td>
				<td><input type="text" id="refund_branchName"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		   
		    </tr>
			<tr>
				<td>营业厅名称：</td>
				<td><input type="text" id="refund_hallName" style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"/></td>
			</tr>
		    <tr>
		    	<td>产品包名称:</td>
				<td><input type="text" id="refund_productName"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		  
			</tr>
			<tr>
		    	<td>生效时间:</td>
				<td><input type="text" id="refund_openTime"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>
			</tr>
			<tr>
		    	<td>失效时间:</td>
				<td><input type="text" id="refund_closeTime"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		    
			</tr>
			<tr>
		    	<td>订单类型:</td>
				<td><input type="text" id="refund_orderTypeName"  style="width:200px;border:1px;color:#D3D3D3;" value="" readonly="readonly"></td>		    
			</tr>
		</table>
	</div>
</div>
