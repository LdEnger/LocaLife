...
<script type="text/javascript" src="js/card/card.js?v=${js_version}"></script>
	...
	<div data-options="region:'center',title:'活动卡券管理'" class="regionCenter">
		<div id="card_toolbar">
			...
			<div>
				...
				<label>卡激活时间：</label>
				 ...
				 <input type="button" id="export_card"	class="btn btn-success" value="导出卡信息" <c:if test="${isBranchUser==0&&isGod_User==0}">
						style="display:none"
					</c:if>>
			</div>
			<div>
				<div <c:if test="${isBranchUser == 0}">
				    ...
				    <input type="button" id="import_btn" class="btn btn-success" value="导入基础信息">
				...
				<div style="display:none"><input type="button" id="batch_del" class="btn btn-success" value="批量删除"></div>
			</div>
		</div>
		...
		<div id="single_card_dialog"
			...
			<table>
				...
				<tr>
					<td>用户号：</td>
					<td><input type="text" id="s_editUserNum" maxlength="90" size="50"></td>
				</tr>
				<tr>
					<td>业务单号：</td>
					<td><input type="text" id="s_editOrderNum" maxlength="90" size="50"></td>
				</tr>
				<tr>
					<td>MAC：</td>
				...
				<tr>
					...
					<td><input type="text" id="s_editAutoActiveTimeLength" title="时间限制最少1天、最多为1095天、如不填默认为365天"><label>天（选填）</label></td>
				</tr>
				<tr>
					<th>&nbsp;</th>
		...
		<div id="batch_card_dialog"
			...
			<table>
				...
				<tr>
					<td>生成数量：</td>
					<td><input type="text" id="b_count"> <label>（必填）</label></td>
				</tr>
				<tr>
					<td title="时间限制最少1天、最多为1095天、如不填默认为365天">激活卡到期时间：</td>
					<td><input type="text" id="d_editAutoActiveTimeLength" title="时间限制最少1天、最多为1095天、如不填默认为365天"><label>天（必填）</label></td>
				</tr>
				<tr>
					<td colspan="2"><font color="red">批量生成耗时较长，请耐心等待不要重复点击</font></td>
				</tr>
			</table>
		</div>
		<!--  excel导入对话框 -->
		<div id="import_card_dialog"
			...
			<table>
				...
				<tr>
					<td title="时间限制最少1天、最多为1095天、如不填默认为365天">激活卡到期时间：</td>
					<td><input type="text" id="i_editAutoActiveTimeLength" title="时间限制最少1天、最多为1095天、如不填默认为365天"><label>天（必填）</label></td>
				</tr>
				<tr>
					<th>&nbsp;</th>
					<td><span class="fcR" style="color: red;">自激活卡生成之日起，在填写天数内未激活的激活卡自动失效</span></td>
