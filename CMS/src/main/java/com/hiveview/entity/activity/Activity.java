...
public class Activity extends Entity implements Serializable {
	...
	private static final long serialVersionUID = 1L;
		...
		public Timestamp insertTime;//生成时间
		...
		public Integer branchId;//创建活动的分公司ID
		public Integer hallId;//创建活动的营业厅ID
		public String branchName;//创建活动的分公司名称
		public String hallName;//创建活动的营业厅名称
		public Integer zoneId;//创建活动的战区ID
		public String zoneName;//创建活动的战区名称
		public Integer cityId;//创建活动的城市ID
		public Integer activityType;//活动类型，包含收费、免费、收费+免费
